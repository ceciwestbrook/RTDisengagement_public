...
if [[ -e "/ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run${run}_dyscontrolandeffortmods_censorRT.feat" ]] ; then
	echo "found old feat"
	rm -r /ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run"${run}"_dyscontrolandeffortmods_censorRT*.feat
	else
...
featfile="/ix1/lhallion/TReW-Brain/Scripts/Level1/level1_fsf_files/dyscontrolandeffortmods/sub-${subject}_ses-01_fsf-lv1_run-${run}_dyscontrolandeffortmods.fsf"
cmd="feat $featfile"
eval $cmd
