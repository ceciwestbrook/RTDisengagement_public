...
if [[ -d "/ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run${run}_ACCmod_censorRT.feat" ]] ; then
	rm -r /ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run${run}_ACCmod_censorRT*.feat
fi
...
featfile="/ix1/lhallion/TReW-Brain/Scripts/Level1/level1_fsf_files/ACCmod/sub-${subject}_ses-01_fsf-lv1_run-${run}_ACCmod.fsf"
cmd="feat $featfile"
eval $cmd
