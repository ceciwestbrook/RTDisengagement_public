...
if [[ -e "/ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run${run}_SARTACCcluster_PPI.feat" ]] ; then
	echo "found old feat"
	rm -r /ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run"${run}"_SARTACCcluster_PPI*.feat
	else
...
featfile="/ix1/lhallion/TReW-Brain/Scripts/PPI/PPI_level1_fsf_files/SARTACC_cluster/sub-${subject}_ses-01_fsf-lv1_run-${run}_SARTACCcluster_PPI.fsf"
cmd="feat $featfile"
eval $cmd
