...
if [[ -e "/ix1/lhallion/TReW-Brain/processed/sub-${subject}/ses-01/level1/run${run}_PCC_PPI_DC.feat" ]] ; then
	echo "found old feat"
...
featfile="/ix1/lhallion/TReW-Brain/Scripts/PPI/PPI_level1_fsf_files/PCC_PPI_DC/sub-${subject}_ses-01_fsf-lv1_run-${run}_PCC_PPI_DC.fsf"
cmd="feat $featfile"
eval $cmd
